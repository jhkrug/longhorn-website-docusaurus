...
1. Download the files from https://github.com/kubernetes-csi/external-snapshotter/tree/v6.3.2/client/config/crd
because Longhorn v[[< current-version >]] uses [CSI external-snapshotter](https://kubernetes-csi.github.io/docs/external-snapshotter.html) v6.3.2
2. Run `kubectl create -k client/config/crd`.
3. Do this once per cluster.

Install the Common Snapshot Controller:
1. Download the files from https://github.com/kubernetes-csi/external-snapshotter/tree/v6.3.2/deploy/kubernetes/snapshot-controller
because Longhorn v[[< current-version >]] uses [CSI external-snapshotter](https://kubernetes-csi.github.io/docs/external-snapshotter.html) v6.3.2
