...
<head>
  <link rel="canonical" href="https://main--longhornio-docusaurus.netlify.app/advanced-resources/os-distro-specific/csi-on-k3s"/>
</head>
...
You can override the root-dir detection by manually setting environment `KUBELET_ROOT_DIR` in https://github.com/longhorn/longhorn/blob/v[[< current-version >]]/deploy/longhorn.yaml.
